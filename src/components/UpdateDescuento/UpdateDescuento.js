    ...
    useEffect(() => {
        const fetchEvent = async () => {
            try {
                ...
                setFechaFinDescuento(response.data.fecha_fin_descuento || '');
            ...
            <div className="bg-light">
                <div className="container-fluid single-section bg-light d-flex">
                    ...
                    <div className="row">
                        ...
                        <h1 className="main-register-title mt-5">Modificar Descuento</h1>
                        </div>
                        <div className="col-12 bg-light p-5 form-register bg-light">
                            ...
                            <form className="m-auto p-5" onSubmit={handleSubmit}>
                                ...
                                <button type="submit" className="btn btn-primary mt-3">Actualizar Descuento</button>
